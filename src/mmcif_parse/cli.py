...
from mmcif_parse.export import dump_json
from mmcif_parse.io import read_structure_summary
from mmcif_parse.pipeline import StructureSkipWarning, infer_case_id, process_single_structure
from mmcif_parse.reporting import build_review_report, collect_case_review_metrics
from mmcif_parse.settings import (
    AppSettings,
...
from mmcif_parse.utils.logging_utils import configure_logging
...
def build_parser(
    ...
    parser = argparse.ArgumentParser(prog="mmcif-parse")
    parser.add_argument(
        "--config",
        type=Path,
        default=config_path,
...
def main(argv: list[str] | None = None) -> int:
    ...
    bootstrap_parser = argparse.ArgumentParser(prog="mmcif-parse", add_help=False)
